...
class Pile_tab:
    ...
    def empiler(self, x):
        ...
        if self.est_pleine():
            ...
            self.sommet += 1          # on avance d'une case
            self.tab[self.sommet] = x # on y écrit la valeur
    ...
    def depiler(self):
        ...
        if self.est_vide():
            ...
            x = self.tab[self.sommet]  # on lit la valeur au sommet
            self.sommet -= 1           # on recule le sommet
            return x
